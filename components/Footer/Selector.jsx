...
function Selector(props) {
  ...
  return (
    <Menu as="div" className="relative inline-block w-full text-left">
      ...
      >
        <Menu.Items className="absolute bottom-10 z-10 mt-2 w-56 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
            {values.map((el) => {
              return (
                <Menu.Item>
                  {({ active }) => (
                    <button
                      ...
                      className={classNames(
                        ...
                        'flex flex-start px-5 py-2 text-sm w-full'
                      )}
                    >
                      {el}
                    </button>
